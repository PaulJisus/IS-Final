<html>
<head>
<title>Pagina de registro de sesion de votación.php</title>
...
<form id="sesion_form">
  ...
  <label for="idVotacion">Número de Votacion:</label><br>
  <input type="text" id="idVotacion" name="idVotacion" value=<?php echo $_GET["id_votacion"]; ?> class="form-control"><br>
    <br>
